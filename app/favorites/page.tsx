        ...
        <div className="flex flex-col items-center justify-center gap-6 relative z-10">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground animate-pulse">
              Preparando tus libros favoritos...
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground ml-14">
              Tus libros marcados como favoritos
            </p>
          </div>
            ...
            {booksLoading ? (
              ...
              <CardContent className="py-16 sm:py-24 px-4">
                <div className="text-center flex flex-col items-center">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-pink-500/10 flex items-center justify-center mb-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-6 max-w-sm">
                    Marca tus libros favoritos desde tu biblioteca para verlos
                    aquí
                  </p>
                  <Button
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-5 gap-4 sm:gap-6">
                  {books.map((book) => (
                    <BookCard
                      ...
                      onCollectionChange={loadFavorites}
                    />
                  ))}
                </div>
              </CardContent>
